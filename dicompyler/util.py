...
def GetResourcePath(resource):
    ...
    if main_is_frozen():
        if (platform() == 'mac'):
            return os.path.join((os.path.join(get_main_dir(), '../Resources')),
                                resource)
...
def GetBasePluginsPath(resource):
    ...
    if main_is_frozen():
        if (platform() == 'mac'):
            return os.path.join((os.path.join(get_main_dir(), '../PlugIns')),
                                resource)
    return os.path.join((os.path.join(get_main_dir(), 'baseplugins')),
                        resource)
